...
## [3.0.0](https://github.com/MuntasirSZN/nvim/compare/v2.0.0...v3.0.0) (2026-07-22)


### ⚠ BREAKING CHANGES

* remove `default_integrations` ([#1019](https://github.com/MuntasirSZN/nvim/issues/1019))
* remove `O.show_end_of_buffer` ([#982](https://github.com/MuntasirSZN/nvim/issues/982))
* move special integrations to `catppuccin-nvim` ([#979](https://github.com/MuntasirSZN/nvim/issues/979))
* remove vim support ([#949](https://github.com/MuntasirSZN/nvim/issues/949))
* move rename `catppuccin` colorscheme to `catppuccin-nvim` ([#977](https://github.com/MuntasirSZN/nvim/issues/977))
...
* add ufo integration ([1f53686](https://github.com/MuntasirSZN/nvim/commit/1f536869b1a2ca1710fc892db84d7e8bbc6ad8d9))
...
* **artio:** add artio.nvim integration ([#972](https://github.com/MuntasirSZN/nvim/issues/972)) ([2fc720c](https://github.com/MuntasirSZN/nvim/commit/2fc720c68bf9950fc15bafb47b8a56f8bb1be315))
...
* **blink-indent:** add blink.indent integration ([#953](https://github.com/MuntasirSZN/nvim/issues/953)) ([da33755](https://github.com/MuntasirSZN/nvim/commit/da33755d00e09bff2473978910168ff9ea5dc453))
* **blink-pairs:** add blink.pairs integration ([#958](https://github.com/MuntasirSZN/nvim/issues/958)) ([193e123](https://github.com/MuntasirSZN/nvim/commit/193e123cdbc4dd3e86db883d55349e9587f0ded6))
...
* **csv:** highlight escaped column ([#1015](https://github.com/MuntasirSZN/nvim/issues/1015)) ([05e8787](https://github.com/MuntasirSZN/nvim/commit/05e8787020dcfdb937bf2ff23855ea2415b4e072))
...
* **dashboard:** add group for hyper theme ([#474](https://github.com/MuntasirSZN/nvim/issues/474)) ([94d10b5](https://github.com/MuntasirSZN/nvim/commit/94d10b558e679447064fe72ddf764b6fea3f0c85))
...
* **editor:** add PmenuBorder hl ([#1010](https://github.com/MuntasirSZN/nvim/issues/1010)) ([0303a72](https://github.com/MuntasirSZN/nvim/commit/0303a7208dba448c459767486a38a6ec05c4216b))
...
* **hl/editor:** add `OkMsg` ([#1014](https://github.com/MuntasirSZN/nvim/issues/1014)) ([e068ab5](https://github.com/MuntasirSZN/nvim/commit/e068ab5f8261f23f6f71ffd8791ae40315b77b9c))
* **hl/editor:** add Dimmed hl ([#1007](https://github.com/MuntasirSZN/nvim/issues/1007)) ([8edd468](https://github.com/MuntasirSZN/nvim/commit/8edd468af4d63212b84d69b2ddb5ffc9023ef5eb))
...
* **integration:** add colorful-winsep.nvim ([#701](https://github.com/MuntasirSZN/nvim/issues/701)) ([30481d6](https://github.com/MuntasirSZN/nvim/commit/30481d659b6524e6bcae0756201d737e5bc1f209))
...
* **lualine:** color overrides for lualine integration  ([#843](https://github.com/MuntasirSZN/nvim/issues/843)) ([6efc53e](https://github.com/MuntasirSZN/nvim/commit/6efc53e42cfc97700f19043105bf73ba83c4ae7d))
...
* luarocks/rocks.nvim support ([#697](https://github.com/MuntasirSZN/nvim/issues/697)) ([29fd8bd](https://github.com/MuntasirSZN/nvim/commit/29fd8bdc8e1b189a9a6aece58a99850fdeb13d5d))
...
* **mini:** add new highlight groups ([#721](https://github.com/MuntasirSZN/nvim/issues/721)) ([6827a67](https://github.com/MuntasirSZN/nvim/commit/6827a6763888f73df686f32c0e5ffb5b6b754d7b))
...
* **neogit:** support inline highlights ([#986](https://github.com/MuntasirSZN/nvim/issues/986)) ([60cf331](https://github.com/MuntasirSZN/nvim/commit/60cf331ed7ecb19617c32bf61eb0da78c4c7bb05))
...
* **octo:** support inline highlights ([#1004](https://github.com/MuntasirSZN/nvim/issues/1004)) ([946d189](https://github.com/MuntasirSZN/nvim/commit/946d189ba5a905c163b3a6d472d79f1f5442c5d5))
...
* **snacks:** use overlay2 as default indent_scope_color ([#975](https://github.com/MuntasirSZN/nvim/issues/975)) ([12c004c](https://github.com/MuntasirSZN/nvim/commit/12c004cde3f36cb1d57242f1e6aac46b09a0e5b4))
* support new "Ok" diagnostics ([5215ea5](https://github.com/MuntasirSZN/nvim/commit/5215ea59df6d0a7e27da9a5cd1165e06d1b04cbe))
...
* check if `auto_integrations` was explicitly disabled ([#1023](https://github.com/MuntasirSZN/nvim/issues/1023)) ([c7c692a](https://github.com/MuntasirSZN/nvim/commit/c7c692a0ad3080710893abbae100171819a3e4be))
...
* config `float` is optional in setup ([#938](https://github.com/MuntasirSZN/nvim/issues/938)) ([af58927](https://github.com/MuntasirSZN/nvim/commit/af58927c55c9f3272c940ff02b3cee94a1249f26))
...
* **editor:** use bg for `FloatShadow` highlight ([#966](https://github.com/MuntasirSZN/nvim/issues/966)) ([4420f0a](https://github.com/MuntasirSZN/nvim/commit/4420f0a50dfde7ee79acf91ded8f97e02883a22a))
...
* **flash:** link `FlashPrompt` to `NormalFloat` ([#605](https://github.com/MuntasirSZN/nvim/issues/605)) ([40dc9f0](https://github.com/MuntasirSZN/nvim/commit/40dc9f0621c55bd40da4ad0731fac44d15bb393a))
...
* **lsp:** do not link `LspInlayHint` to `Comment` directly ([#517](https://github.com/MuntasirSZN/nvim/issues/517)) ([5dc566c](https://github.com/MuntasirSZN/nvim/commit/5dc566c4206f383657d67500253559d3be82c421))
...
* move rename `catppuccin` colorscheme to `catppuccin-nvim` ([#977](https://github.com/MuntasirSZN/nvim/issues/977)) ([6d4e80f](https://github.com/MuntasirSZN/nvim/commit/6d4e80f8bde41b893c9bc7b07460af3155a3adfa))
* move special integrations to `catppuccin-nvim` ([#979](https://github.com/MuntasirSZN/nvim/issues/979)) ([384f304](https://github.com/MuntasirSZN/nvim/commit/384f304c8b04664c9e0091fbfb3923c5f97c1bcf))
...
* **noice:** cursor is invisible ([4606b68](https://github.com/MuntasirSZN/nvim/commit/4606b68140ee7003d32892fc297bce66e2348df2))
...
* remove `default_integrations` ([#1019](https://github.com/MuntasirSZN/nvim/issues/1019)) ([058e83d](https://github.com/MuntasirSZN/nvim/commit/058e83dc009e4dd62f30807054de9cc849699e27))
* remove `O.show_end_of_buffer` ([#982](https://github.com/MuntasirSZN/nvim/issues/982)) ([50c34a2](https://github.com/MuntasirSZN/nvim/commit/50c34a2cf18776a77f770fcf5df777de6fe69e08))
...
* **telescope:** respect default float bg ([251774e](https://github.com/MuntasirSZN/nvim/commit/251774ec0705c1b6b0d9fb7f93b495da73357e0e)), closes [#470](https://github.com/MuntasirSZN/nvim/issues/470)
...
* **treesitter_context:** context follows normal transparency ([#956](https://github.com/MuntasirSZN/nvim/issues/956)) ([180e043](https://github.com/MuntasirSZN/nvim/commit/180e0435707cf1fed09a98a9739e5807d92b69be))
...
* **treesitter:** `[@type](https://github.com/type).builtin` styles ([#944](https://github.com/MuntasirSZN/nvim/issues/944)) ([0a5de4d](https://github.com/MuntasirSZN/nvim/commit/0a5de4da015a175f416d6ef1eda84661623e0500))
...
* **treesitter:** use text for html heading content ([#948](https://github.com/MuntasirSZN/nvim/issues/948)) ([ce4a8e0](https://github.com/MuntasirSZN/nvim/commit/ce4a8e0d5267e67056f9f4dcf6cb1d0933c8ca00))
* **trouble:** link non-current trouble normal hl to trouble normal hl ([#961](https://github.com/MuntasirSZN/nvim/issues/961)) ([ce8d176](https://github.com/MuntasirSZN/nvim/commit/ce8d176faa4643e026e597ae3c31db59b63cef09))
...
* **vim.pack:** error if git is not installed ([#995](https://github.com/MuntasirSZN/nvim/issues/995)) ([0de2b6d](https://github.com/MuntasirSZN/nvim/commit/0de2b6d98954c5db2a0dba28c18f489ab7fe0827))
...
* remove vim support ([#949](https://github.com/MuntasirSZN/nvim/issues/949)) ([1444322](https://github.com/MuntasirSZN/nvim/commit/14443226bdd9ed3a414c5145eb6522023654d387))
